    ...
    return (
        <main className="mainPage">
            ...
            <div className="mainPageArticle">
                ...
                <a href="https://ent30.jctv.ntut.edu.tw/applyRuleReport" className="externalLinks">招生簡章</a>
                <Link to="/KnowUsPage" className="nextPage">認識創設</Link>
            </div>
        </main>
    )
}
